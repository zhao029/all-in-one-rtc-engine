...
#import "TRTCAppTypes.h"

@interface TRTCMainViewController : UIViewController 

@property (nonatomic) TRTCLoginParam *param;    /// TRTC SDK 视频通话房间进入所必须的参数
//@property (nonatomic) BOOL  pureAudioMode;
@property (nonatomic, assign) BOOL useTRTC;
@property (nonatomic, assign) AgoraChannelProfile appScene;
@property (nonatomic, assign) AgoraAudioProfile audioProfile;
@property (nonatomic, strong) AgoraVideoEncoderConfiguration *videoProfile;
