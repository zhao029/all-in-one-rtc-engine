...
- (void)layoutSubviews
{
    ...
    [self relayout];
    //Agora会将视频View放到最上面
    for (UIView *v in @[_btnMuteAudio, _btnMuteVideo, _btnScaleMode]) {
...
- (void)setLogHidden:(BOOL)logHidden {
    _logHidden = logHidden;
    [[self viewWithTag:TRTCVideoViewConstants.logLabelTag] setHidden: logHidden];
}
